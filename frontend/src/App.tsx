...
function App() {
  ...
  return <div className="app-shell">
    <style>{` .demo-panel{margin:40px auto;max-width:1180px;padding:28px;border:1px solid #eadfdb;border-radius:24px;background:#fff}.demo-head{display:flex;justify-content:space-between;gap:20px;align-items:end;margin-bottom:22px}.demo-filters{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:24px}.demo-filters label{display:flex;flex-direction:column;gap:6px;font-size:13px}.demo-filters select{padding:10px 12px;border:1px solid #d8cbc6;border-radius:10px;background:#fff}.demo-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(235px,1fr));gap:16px}.demo-card{padding:20px;border:1px solid #eee3df;border-radius:18px;background:#fff}.demo-avatar{width:58px;height:58px;border-radius:50%;display:grid;place-items:center;background:#f4e5e1;font-size:22px;font-weight:700;margin-bottom:12px}.demo-tags{display:flex;gap:6px;flex-wrap:wrap;margin:14px 0}.demo-tag{padding:5px 9px;border-radius:999px;background:#f7f1ef;font-size:12px}.demo-actions{display:flex;gap:8px}.demo-actions button{flex:1}.demo-note{font-size:13px;opacity:.75}.demo-detail{margin-top:20px;padding:20px;border-radius:16px;background:#faf6f4}.demo-panel h2{margin:0 0 8px}.demo-panel h3{margin:0 0 6px}.connection-bar{display:flex;justify-content:space-between;align-items:center;gap:16px;margin-top:24px;padding:16px 18px;border:1px solid #eadfdb;border-radius:16px;background:#fcfaf9}.chat{margin-top:16px;border:1px solid #eadfdb;border-radius:18px;overflow:hidden}.chat-head{padding:16px 18px;background:#faf6f4;display:flex;align-items:center;gap:12px}.chat-head .demo-avatar{width:42px;height:42px;margin:0;font-size:17px}.chat-body{padding:18px;display:flex;flex-direction:column;gap:10px;max-height:320px;overflow:auto}.bubble{max-width:78%;padding:10px 13px;border-radius:14px;font-size:14px;line-height:1.45}.bubble.me{align-self:flex-end;background:#f0e2de}.bubble.them{align-self:flex-start;background:#f5f5f5}.bubble small{display:block;margin-top:4px;opacity:.55;font-size:10px}.chat-form{display:flex;gap:8px;padding:12px;border-top:1px solid #eee3df}.chat-form input{flex:1;padding:11px 12px;border:1px solid #d8cbc6;border-radius:10px}.chat-form button{white-space:nowrap}.demo-empty{text-align:center;padding:35px}.auth-panel{margin-top:40px}.auth-panel,.principles,.safety-banner{margin-left:auto;margin-right:auto;max-width:1180px}@media(max-width:700px){.demo-panel{margin:24px 12px;padding:18px}.demo-head{display:block}.connection-bar{align-items:flex-start;flex-direction:column}.chat-form{flex-wrap:wrap}.chat-form input{min-width:100%}}`} .legal-consents{display:grid;gap:10px;margin:14px 0;padding:14px;border:1px solid #eadfdb;border-radius:12px;background:#fcfaf9;font-size:13px}.legal-consents label{display:flex;gap:9px;align-items:flex-start;line-height:1.4}.legal-consents input{margin-top:3px}.legal-consents p{margin:2px 0 0;font-size:12px;opacity:.72;line-height:1.45}</style>
